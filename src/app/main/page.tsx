      ...
      `}</style>
        ...
        <section className="bg-white py-16 md:py-24 rounded-lg shadow-inner mx-4 my-8">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center md:space-x-12">
            ...
            <div className="md:w-1/2 flex justify-center">
              <Image src="/ssabab_logo.png" alt="SSABAB 서비스 이미지" width={500} height={500} className="w-full max-w-md rounded-lg shadow-xl" />
            </div>
          </div>
        </section>
        ...
        <section className="section-gradient-gold text-white py-16 md:py-24 rounded-lg shadow-inner mx-4 my-8">
          <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center md:space-x-12">
            <div className="md:w-1/2 flex justify-center">
              <Image src="/haerine.png" alt="팀 해리네 이미지" width={500} height={500} className="w-full max-w-md rounded-lg shadow-xl" />
            </div>
            <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
              ...
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/000000/FFFFFF?text=Next.js" alt="Next.js 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">Next.js</p>
              </div>
              {/* Tech Stack Item: Spring Boot */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/6DB33F/FFFFFF?text=Spring" alt="Spring Boot 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">Spring Boot</p>
              </div>
              {/* Tech Stack Item: MySQL */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/00758F/FFFFFF?text=MySQL" alt="MySQL 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">MySQL</p>
              </div>
              {/* Tech Stack Item: AWS */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/FF9900/FFFFFF?text=AWS" alt="AWS 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">AWS</p>
              </div>
              {/* Tech Stack Item: Kubernetes (K8s) */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/326CE5/FFFFFF?text=K8s" alt="Kubernetes 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">Kubernetes</p>
              </div>
              {/* Tech Stack Item: Prometheus */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/E6522C/FFFFFF?text=Prometheus" alt="Prometheus 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">Prometheus</p>
              </div>
              {/* Tech Stack Item: Grafana */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/F05A28/FFFFFF?text=Grafana" alt="Grafana 로고" width={80} height={80} className="w-20 h-20 mb-3" />
                <p className="font-bold text-lg text-gray-800">Grafana</p>
              </div>
              {/* Tech Stack Item: ELK Stack */}
              <div className="flex flex-col items-center p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <Image src="https://placehold.co/80x80/00BFB3/FFFFFF?text=ELK" alt="ELK Stack 로고" width={80} height={80} className="w-20 h-20 mb-3" />
